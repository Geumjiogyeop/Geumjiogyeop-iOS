...
class myListViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        myListCollectionView.collectionViewLayout = layout
    }
    ...
    override func viewDidLayoutSubviews() {
         ...
         // 컬렉션 뷰 가로 크기 설정
         if let flowLayout = myListCollectionView.collectionViewLayout as? UICollectionViewFlowLayout {
             flowLayout.itemSize = CGSize(width: myListCollectionView.bounds.width - 48, height: 128)
         }
     }
